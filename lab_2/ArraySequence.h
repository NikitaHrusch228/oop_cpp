#pragma once
// Аннотация
// Реализуем класс последовательности на основе динамического массива
...
//      Создание последовательности из массива, Конвертация ЛинкедЛиста в наш класс
//      Возвращение элемента по списку, добавление элемента в конец, добавление элемента в начало
